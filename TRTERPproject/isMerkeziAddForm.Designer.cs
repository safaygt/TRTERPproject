...
{
	partial class isMerkeziAddForm
	{
		/// <summary>
		...
		{
			ismerkUAtextBox = new TextBox();
			label13 = new Label();
			textBoxGunlukCal = new TextBox();
			label12 = new Label();
			comboBoxMaliMerk = new ComboBox();
			maliyMerkTxtBox = new TextBox();
			label10 = new Label();
			label11 = new Label();
			anaismerkod = new TextBox();
			anaismertip = new TextBox();
			label5 = new Label();
			label9 = new Label();
			...
			// ismerkUAtextBox
			// 
			ismerkUAtextBox.Location = new Point(870, 253);
			ismerkUAtextBox.Name = "ismerkUAtextBox";
			ismerkUAtextBox.Size = new Size(367, 27);
			ismerkUAtextBox.TabIndex = 145;
			// 
			// label13
			// 
			...
			label13.Location = new Point(951, 227);
			label13.Name = "label13";
			label13.Size = new Size(227, 23);
			label13.TabIndex = 144;
			label13.Text = "İş Merkezi Uzun Açıklaması";
			// 
			// textBoxGunlukCal
			// 
			textBoxGunlukCal.Location = new Point(458, 154);
			textBoxGunlukCal.Name = "textBoxGunlukCal";
			textBoxGunlukCal.Size = new Size(239, 27);
			textBoxGunlukCal.TabIndex = 143;
			// 
			// label12
			// 
			...
			label12.Location = new Point(458, 123);
			label12.Name = "label12";
			label12.Size = new Size(239, 23);
			label12.TabIndex = 142;
			label12.Text = "Günlük Çalışma Süresi (Saat)";
			// 
			// comboBoxMaliMerk
			// 
			comboBoxMaliMerk.DropDownStyle = ComboBoxStyle.DropDownList;
			comboBoxMaliMerk.FormattingEnabled = true;
			comboBoxMaliMerk.Location = new Point(49, 153);
			comboBoxMaliMerk.Name = "comboBoxMaliMerk";
			comboBoxMaliMerk.Size = new Size(186, 28);
			comboBoxMaliMerk.TabIndex = 141;
			// 
			// maliyMerkTxtBox
			// 
			maliyMerkTxtBox.Location = new Point(260, 154);
			maliyMerkTxtBox.Name = "maliyMerkTxtBox";
			maliyMerkTxtBox.Size = new Size(181, 27);
			maliyMerkTxtBox.TabIndex = 140;
			// 
			// label10
			// 
			...
			label10.Location = new Point(63, 123);
			label10.Name = "label10";
			label10.Size = new Size(175, 23);
			label10.TabIndex = 139;
			label10.Text = "Maliyet Merkezi Tipi";
			// 
			// label11
			// 
			...
			label11.Location = new Point(260, 123);
			label11.Name = "label11";
			label11.Size = new Size(186, 23);
			label11.TabIndex = 138;
			label11.Text = "Maliyet Merkezi Kodu";
			// 
			// anaismerkod
			// 
			anaismerkod.Location = new Point(260, 253);
			anaismerkod.Name = "anaismerkod";
			anaismerkod.Size = new Size(181, 27);
			anaismerkod.TabIndex = 137;
			// 
			// anaismertip
			// 
			anaismertip.Location = new Point(49, 253);
			anaismertip.Name = "anaismertip";
			anaismertip.Size = new Size(181, 27);
			anaismertip.TabIndex = 136;
			// 
			// label5
			// 
			...
			label5.TabIndex = 135;
			label5.Text = "Ana İş Merkezi Tipi";
			// 
			// label9
			// 
			...
			label9.Location = new Point(260, 222);
			label9.Name = "label9";
			label9.Size = new Size(174, 23);
			label9.TabIndex = 134;
			label9.Text = "Ana İş Merkezi Kodu";
			// 
			// dateTimeBit
			// 
			dateTimeBit.Location = new Point(911, 154);
			dateTimeBit.Name = "dateTimeBit";
			dateTimeBit.Size = new Size(210, 27);
			dateTimeBit.TabIndex = 133;
			// 
			// dateTimeBas
			// 
			dateTimeBas.Location = new Point(870, 66);
			dateTimeBas.Name = "dateTimeBas";
			dateTimeBas.Size = new Size(210, 27);
			dateTimeBas.TabIndex = 132;
			...
			label8.Location = new Point(950, 129);
			label8.Name = "label8";
			...
			label2.Location = new Point(673, 39);
			label2.Name = "label2";
			...
			dilBox.Location = new Point(714, 153);
			dilBox.Name = "dilBox";
			...
			firmbox.Location = new Point(49, 64);
			firmbox.Name = "firmbox";
			firmbox.Size = new Size(167, 28);
			firmbox.TabIndex = 126;
			// 
			// checkboxpas
			// 
			...
			checkboxpas.Location = new Point(1150, 65);
			...
			deletedlbl.Location = new Point(1150, 137);
			...
			// saveBut
			// 
			saveBut.Location = new Point(1075, 342);
			saveBut.Name = "saveBut";
			saveBut.Size = new Size(149, 56);
			saveBut.TabIndex = 123;
			saveBut.Text = "Kaydet";
			saveBut.UseVisualStyleBackColor = true;
			saveBut.Click += saveBut_Click_1;
			// 
			// ismerkKATxtBox
			// 
			ismerkKATxtBox.Location = new Point(469, 253);
			ismerkKATxtBox.Name = "ismerkKATxtBox";
			ismerkKATxtBox.Size = new Size(367, 27);
			ismerkKATxtBox.TabIndex = 122;
			// 
			// ismerkodtxtBox
			// 
			ismerkodtxtBox.Location = new Point(440, 64);
			ismerkodtxtBox.Name = "ismerkodtxtBox";
			ismerkodtxtBox.Size = new Size(181, 27);
			ismerkodtxtBox.TabIndex = 121;
			// 
			// dillbl
			// 
			...
			dillbl.Location = new Point(753, 128);
			dillbl.Name = "dillbl";
			...
			label6.Location = new Point(260, 37);
			label6.Name = "label6";
			...
			label4.Location = new Point(894, 39);
			label4.Name = "label4";
			...
			label3.Location = new Point(469, 39);
			label3.Name = "label3";
			...
			maliylbl.Location = new Point(550, 227);
			maliylbl.Name = "maliylbl";
			maliylbl.Size = new Size(219, 23);
			maliylbl.TabIndex = 116;
			maliylbl.Text = "İş Merkezi Kısa Açıklaması";
			// 
			// label1
			// 
			...
			ClientSize = new Size(1322, 445);
			Controls.Add(ismerkUAtextBox);
			Controls.Add(label13);
			Controls.Add(textBoxGunlukCal);
			Controls.Add(label12);
			Controls.Add(comboBoxMaliMerk);
			Controls.Add(maliyMerkTxtBox);
			Controls.Add(label10);
			Controls.Add(label11);
			Controls.Add(anaismerkod);
			Controls.Add(anaismertip);
			Controls.Add(label5);
			Controls.Add(label9);
			...
			Controls.Add(label1);
			Name = "isMerkeziAddForm";
			Text = "isMerkeziAddForm";
			ResumeLayout(false);
			PerformLayout();
		}
		...
		private TextBox ismerkUAtextBox;
		private Label label13;
		private TextBox textBoxGunlukCal;
		private Label label12;
		private ComboBox comboBoxMaliMerk;
		private TextBox maliyMerkTxtBox;
		private Label label10;
		private Label label11;
		private TextBox anaismerkod;
		private TextBox anaismertip;
		...
		private TextBox ismerkKATxtBox;
