namespace TRTERPproject
{
	partial class RotaKartAna
	{
		...
		private void InitializeComponent()
		{
			...
			// duzBut
			// 
			duzBut.Location = new Point(566, 271);
			duzBut.Name = "duzBut";
			...
			// DelBut
			// 
			DelBut.Location = new Point(402, 271);
			DelBut.Name = "DelBut";
			...
			// addBut
			// 
			addBut.Location = new Point(234, 271);
			addBut.Name = "addBut";
			...
			// getBut
			// 
			getBut.Location = new Point(66, 271);
			getBut.Name = "getBut";
			...
			// basTarTxtBox
			// 
			basTarTxtBox.Location = new Point(902, 85);
			...
			label5.Location = new Point(928, 136);
			label5.Name = "label5";
			...
			label4.Location = new Point(902, 59);
			label4.Name = "label4";
			...
			label3.Location = new Point(473, 59);
			label3.Name = "label3";
			...
			maliylbl.Location = new Point(185, 146);
			maliylbl.Name = "maliylbl";
			maliylbl.Size = new Size(138, 23);
			maliylbl.TabIndex = 49;
			maliylbl.Text = "Rota Açıklaması";
			// 
			// label1
			// 
