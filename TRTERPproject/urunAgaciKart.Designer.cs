namespace TRTERPproject
{
	partial class urunAgaciKart
	{
		...
		private void InitializeComponent()
		{
			...
			checkboxpas.Location = new Point(846, 225);
			...
			deletedlbl.Location = new Point(846, 260);
			...
			// duzBut
			// 
			duzBut.Location = new Point(527, 261);
			duzBut.Name = "duzBut";
			...
			// DelBut
			// 
			DelBut.Location = new Point(363, 261);
			DelBut.Name = "DelBut";
			...
			// addBut
			// 
			addBut.Location = new Point(195, 261);
			addBut.Name = "addBut";
			...
			// getBut
			// 
			getBut.Location = new Point(27, 261);
			getBut.Name = "getBut";
			...
			label5.Location = new Point(856, 134);
			label5.Name = "label5";
			...
			label4.Location = new Point(841, 48);
			label4.Name = "label4";
			...
			// textBox1
			// 
			textBox1.Location = new Point(299, 161);
			...
			label7.Location = new Point(299, 136);
			label7.Name = "label7";
